...
#1) Run Du et al 'clean.iobp' function. Added 'thresh' argument to function in order to modify parameters
```{r}
########################################################################################################
...
5) Plot original and clean bp traces ##FIX GAPS IN TRACE
```{r}
